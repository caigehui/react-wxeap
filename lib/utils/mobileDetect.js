...
module.exports = {
  ...
  isIOS: md.os() === 'iOS' || window.navigator.userAgent === 'wxeap-app-ios',
  ...
  isAndroid: md.os() === 'AndroidOS' || window.navigator.userAgent === 'wxeap-app-android',
  isWindow: md.os() === 'WindowsMobileOS' || md.os() === 'WindowsPhoneOS',
  isMobile: (md.mobile() !== null ? true : false) || window.navigator.userAgent === 'wxeap-app-ios' || window.navigator.userAgent === 'wxeap-app-android',
  isWechat: md.match('MicroMessenger') ? true : false,
  wechatVer: md.version('MicroMessenger') ? md.version('MicroMessenger') : null,
  isApp: window.navigator.userAgent === 'wxeap-app-ios' || window.navigator.userAgent === 'wxeap-app-android'
};