...
var ImagePickerCompress = (_temp2 = _class = function (_React$Component) {
    ...
    function ImagePickerCompress() {
        ...
        }, _this.onImagePicked = function (e) {
            var message = JSON.parse(e.data);
            if (message.type === 'onImagePicked') {
                _this.props.onChange && _this.props.onChange([].concat(_toConsumableArray(_this.props.files), [{ url: message.payload.imageData, orientation: 1 }]), 'add', _this.props.files.length);
            }
