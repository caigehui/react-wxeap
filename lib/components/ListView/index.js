...
var _class = function (_React$Component) {
    ...
    function _class(props) {
        ...
        _this.scrollTo = function (y) {
            _this.scroller.scrollTo(0, y, true);
        };

        _this.locateToBottom = function () {
            _this.scroller.scrollTo(0, _this.domScroller.content.clientHeight - _this.domScroller.clientSize.y);
        };

        _this.fill = function (data, allLoaded, page) {
            try {
                data = _this.props.mode === 'default' ? data : data.reverse();
                if (_this.firstLoaded) {
                    _this.firstFill = true;
                }
                if (!page) {
        ...
        _this.onEndReached = function () {
            if (_this.props.mode === 'reverse') return;
    ...
    _createClass(_class, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                scrollBarDiabled = _props.scrollBarDiabled,
                mode = _props.mode;
            ...
            var listView = _react2.default.createElement(_listView2.default, _extends({
                ...
                initialListSize: 0,
                renderHeader: mode === 'default' ? renderHeader || header ? function () {
                    return _react2.default.createElement(
                        'span',
                        null,
                        header
                    );
                } : null : this.renderReverseHeader,
                renderFooter: mode === 'default' ? this.props.renderFooter ? function () {
                ...
                refreshControl: refreshable && mode === 'default' ? _react2.default.createElement(_refreshControl2.default, {
...
_class.propTypes = {
    ...
    scrollBarDiabled: _react.PropTypes.bool,
    mode: _react.PropTypes.oneOf(['default', 'reverse'])
};
_class.defaultProps = {
    refreshable: true,
    listId: 'temp',
