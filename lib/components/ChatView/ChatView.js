...
var ChatView = _react2.default.createClass({
	...
	propTypes: {
		...
		stayPosition: _react2.default.PropTypes.bool
	},
	...
	render: function render() {
		...
		return _react2.default.createElement(
			'div',
			{ className: this.props.className, ref: 'scrollable', id: 'ChatView',
				style: _extends({ overflowX: 'hidden', overflowY: 'scroll' }, this.props.style) },
