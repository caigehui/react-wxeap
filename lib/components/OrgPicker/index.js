...
var OrgPicker = function (_React$Component) {
    ...
    function OrgPicker(props) {
        ...
        _this.onConfirm = function () {
            if (_this.state.checked.length === 0) return;
        ...
        value: function renderCheckedContainer() {
            ...
            checked.map(function (item, i) {
                checkedEl.push(_react2.default.createElement(
                    'div',
                    { key: i, style: _extends({}, styles.item, { color: COLORS.RED_COLOR
                        }) },
                    item.name
                ));
                                    ...
                                    if (item.type !== 'all') {
                                        return _react2.default.createElement(
                                            ListItem,
                                            {
                                                ...
                                                thumb: item.type === 'dpt' ? _react2.default.createElement('img', { src: require('../../assets/org.png'), style: styles.icon }) : !item.avatarHash ? _react2.default.createElement(
                                                    'div',
                                                ...
                                                extra: item.type === 'emp' ? checked.searchByCondition(function (a) {
                                                    ...
                                                    size: 'md', color: COLORS.PRIMARY_COLOR }) : null : _react2.default.createElement(_icon2.default, { type: 'right',
                ...
                _react2.default.createElement(
                    _navBar2.default,
                    {
                        ...
                        rightContent: this.props.type === 'empRadio' || this.props.type === 'dptRadio' ? null : _react2.default.createElement(
                            ...
                            _react2.default.createElement(_icon2.default, { type: require('../../assets/tick.svg'), color: this.state.checked.length > 0 ? COLORS.PRIMARY_COLOR : 'rgba(74, 144, 226, 0.3)' })
                        )
                    },
                    this.getNavTitle()
                ),
