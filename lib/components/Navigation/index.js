...
var Navigation = function (_React$Component) {
  ...
  function Navigation(props) {
    ...
    _this.state = {
      ...
      switchCompany: false,
      showMenu: false,
      navTitle: !props.homeMode ? '' : _this.getNavTitle(props.menuValue, props.menuData)
    };
    return _this;
  }
  ...
  _createClass(Navigation, [{
    ...
    value: function render() {
      ...
      var menu = _react2.default.createElement(_menu2.default, {
        className: _index2.default.fooMenu,
        ...
        leftProps = {
          ...
          leftContent: _react2.default.createElement(
            ...
            messages.length > 0 ? _react2.default.createElement(
              'div',
              { key: '2', style: inlineStyles.message, onClick: this.props.onMessagesClick },
      ...
      return _react2.default.createElement(
        'div',
        { className: showMenu ? _index2.default.menuActive : '' },
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(
