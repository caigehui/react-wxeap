...
var WXListView = (_temp = _class = function (_React$Component) {
    _inherits(WXListView, _React$Component);

    function WXListView(props) {
        _classCallCheck(this, WXListView);

        var _this = _possibleConstructorReturn(this, (WXListView.__proto__ || Object.getPrototypeOf(WXListView)).call(this, props));
        ...
        _this.onRefresh = function () {
            ...
            if (refreshing === false) {
                _this.setState({ refreshing: true, isLoading: true, page: 1 });
                _this.send(1);
            }
        };
