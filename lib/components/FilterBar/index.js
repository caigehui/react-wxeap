...
var FilterBar = (_temp = _class = function (_React$Component) {
        ...
        value: function render() {
            ...
            return conditions.length > 0 ? _react2.default.createElement(
                ...
                conditions.map(function (item, i) {
                    ...
                    var isShowSwitchBtn = switchBtns.searchByCondition(function (index) {
                        return i === index;
                    });
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _View2.default,
                            { style: iconStyle },
                            _react2.default.createElement(_icon2.default, { type: isShowSwitchBtn ? require('../../assets/switch.svg') : require('../../assets/triangle.svg'), size: isShowSwitchBtn ? 'xs' : 'xxs', color: iconColor })
                        )
                    );
                }),
    ...
    switchBtns: _react.PropTypes.array
}, _class.defaultProps = {
