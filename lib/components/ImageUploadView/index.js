...
var ImageUploadView = (_temp2 = _class = function (_React$Component) {
    ...
    function ImageUploadView() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ImageUploadView.__proto__ || Object.getPrototypeOf(ImageUploadView)).call.apply(_ref, [this].concat(args))), _this), _this._onImagePicked = function (message) {
            if (message.type === 'onImagePicked') {
                setTimeout(function () {
                    _this.props.onImagePicked && _this.props.onImagePicked(message.payload.imageData);
                }, _MobileDetect2.default.isIOS ? 0 : 500);
            }
    ...
    _createClass(ImageUploadView, [{
        ...
        value: function componentDidMount() {
            _MessageBridge2.default.addMessageListener(this._onImagePicked);
        }
    }, {
        key: 'componentWillUnMount',
        value: function componentWillUnMount() {
            _MessageBridge2.default.removeMessageListener(this._onImagePicked);
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _MobileDetect2.default.isApp ? null : _react2.default.createElement('input', {
                    style: {
                        opacity: 0,
                        position: 'absolute',
                        left: 0,
