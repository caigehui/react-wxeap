...
var _mobileMiddleware = require('./mobileMiddleware');

var _mobileMiddleware2 = _interopRequireDefault(_mobileMiddleware);
...
var MobileApp = function () {
    ...
    function MobileApp(routes, options) {
        ...
        this.mobileApp = (0, _dva2.default)({
            onAction: [_mobileMiddleware2.default].concat(_toConsumableArray(middlewares)),
        ...
        value: function start() {
            ...
            if (CONSTANTS.DEV_MODE && this.auth && this.auth.length > 0) {
                fetch(this.origin + this.auth, { credentials: 'include' }).then(function () {
                    ...
                    (0, _reduxPersist.persistStore)(_this2.mobileApp._store, { storage: _storages.asyncSessionStorage });
                });
            } else {
                this.mobileApp.start('#root');
                (0, _reduxPersist.persistStore)(this.mobileApp._store, { storage: _storages.asyncSessionStorage });
            }
        }
    }, {
        key: 'addModel',
