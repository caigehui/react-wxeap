        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _View2.default,
                    { style: _extends({}, styles.container, { height: height }), onClick: disabled ? null : function () {
                            return onClick && onClick(!checked);
                        } },
                    checkable ? _react2.default.createElement(
                        _View2.default,
                        { style: styles.checkContainer, onClick: disabled ? null : this.onCheck },
                        _react2.default.createElement(
                            _View2.default,
                            { style: checked ? _extends({}, styles.check, { border: '1.5px solid ' + (disabled ? COLORS.SUBTITLE_COLOR : COLORS.PRIMARY_COLOR) }) : styles.check },
                            checked ? _react2.default.createElement(_icon2.default, { type: 'check', color: disabled ? COLORS.SUBTITLE_COLOR : COLORS.PRIMARY_COLOR }) : null
                        )
