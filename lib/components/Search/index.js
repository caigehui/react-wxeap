...
var Search = function (_Component) {
    ...
    function Search(props) {
        ...
        _this.onSubmit = function (value) {
            ...
            if (!value) return _this.setState({ isInit: true, focused: false });
            // 触发onSearch
            _this.props.onSearch && _this.props.onSearch(value, function (list) {
                if (!_this.mounted) return;
                _this.setState({ isEmpty: list.length === 0 });
                _this.listView.fill(list, true);
            });
            _this.setState({ isInit: false, focused: false });
        };
