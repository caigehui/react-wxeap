...
var PinchZoomView = (_temp = _class = function (_React$Component) {
    _inherits(PinchZoomView, _React$Component);

    function PinchZoomView() {
        _classCallCheck(this, PinchZoomView);

        return _possibleConstructorReturn(this, (PinchZoomView.__proto__ || Object.getPrototypeOf(PinchZoomView)).apply(this, arguments));
    }

    _createClass(PinchZoomView, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            var view = document.getElementById('pinch-zoom-view');
            view.style.webkitTransform = 'translate3d(0px, 0px, 0) ' + 'scale3d(' + this.props.initScale + ', ' + this.props.initScale + ', 1)';
            hammerIt(view);
        }
    }, {
        key: 'render',
    ...
    initScale: _react2.default.PropTypes.number
}, _class.defaultProps = {
    initScale: 1
}, _temp);
