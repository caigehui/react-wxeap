...
export default class FilterBar extends React.Component {
    ...
    componentDidMount() {
        this.setState({ offsetTop: findDOMNode(this.bar).offsetTop, labels: labels[this.props.filterBarId] && labels[this.props.filterBarId].length ? labels[this.props.filterBarId] : this.state.labels });
    }
