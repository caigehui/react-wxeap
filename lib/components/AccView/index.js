...
var AccView = (_temp2 = _class = function (_React$Component) {
    ...
    function AccView() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AccView.__proto__ || Object.getPrototypeOf(AccView)).call.apply(_ref, [this].concat(args))), _this), _this.getFileType = function (fileName) {
            ...
            if (filetype === 'png' || filetype === 'jpg' || filetype === 'jpeg' || filetype === 'gif') (0, _ImageViewer2.default)(0, [{ url: EAP + 'Service/WxGetFile.ashx?hash=' + acc.hash }]);else window.location.href = Acc.getPreviewPath(acc.id);
    ...
    _createClass(AccView, [{
        ...
        value: function getFileImg(acc) {
            ...
            } else if (filetype === 'txt') return EAP + 'Images/Yunpan/txt80.png';else if (filetype === 'xls' || filetype === 'xlsx') return EAP + 'Images/Yunpan/Xls80.png';else if (filetype === 'doc' || filetype === 'docx') return EAP + 'Images/Yunpan/Doc80.png';else if (filetype === 'pptx' || filetype === 'ppt') return EAP + 'Images/Yunpan/PPT80.png';else if (filetype === 'zip' || filetype === 'rar') return EAP + 'Images/Yunpan/Zip80.png';else if (filetype === 'pdf') return EAP + 'Images/Yunpan/PDF80.png';else return EAP + 'Images/Yunpan/Unknown80.png';
        }
    }, {
        key: 'render',
